...
void main() {
  ...
  group('SSL Pinning', () {
    test('should throw an exception when SSL pinning fails', () async {
      ...
      expect(() async => await dataSource.getNowPlayingTv(),
  ...
  group('get Now Playing Tv', () {
    final tTvList = TvResponse.fromJson(
            json.decode(tvReadJson('dummy_data/tv_now_playing.json')))
        .tvList;
    ...
    test('should return list of Tv Model when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse('$baseUrl/tv/airing_today?$apiKey')))
          .thenAnswer((_) async =>
              http.Response(tvReadJson('dummy_data/tv_now_playing.json'), 200));
      // act
  ...
  group('get Popular Tv', () {
    final tTvList = TvResponse.fromJson(
            json.decode(tvReadJson('dummy_data/tv_popular.json')))
        .tvList;
    ...
    test('should return list of tvs when response is success (200)', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$baseUrl/tv/popular?$apiKey')))
          .thenAnswer((_) async =>
              http.Response(tvReadJson('dummy_data/tv_popular.json'), 200));
      // act
  ...
  group('get Top Rated Tv', () {
    final tTvList = TvResponse.fromJson(
            json.decode(tvReadJson('dummy_data/tv_top_rated.json')))
        .tvList;
    ...
    test('should return list of tvs when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$baseUrl/tv/top_rated?$apiKey')))
          .thenAnswer((_) async =>
              http.Response(tvReadJson('dummy_data/tv_top_rated.json'), 200));
      // act
  ...
  group('get tv detail', () {
    ...
    final tTvDetail = TvDetailResponse.fromJson(
        json.decode(tvReadJson('dummy_data/tv_detail.json')));

    test('should return tv detail when the response code is 200', () async {
      // arrange
      when(mockHttpClient.get(Uri.parse('$baseUrl/tv/$tId?$apiKey')))
          .thenAnswer((_) async =>
              http.Response(tvReadJson('dummy_data/tv_detail.json'), 200));
      // act
  ...
  group('get tv recommendations', () {
    final tTvList = TvResponse.fromJson(
            json.decode(tvReadJson('dummy_data/tv_recommendations.json')))
        .tvList;
    const tId = 1;
    ...
    test('should return list of Tv Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              tvReadJson('dummy_data/tv_recommendations.json'), 200));
      // act
  ...
  group('search tvs', () {
    final tSearchResult = TvResponse.fromJson(
            json.decode(tvReadJson('dummy_data/tv_search_spiderman.json')))
        .tvList;
    ...
    test('should return list of tvs when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              tvReadJson('dummy_data/tv_search_spiderman.json'), 200));
      // act
